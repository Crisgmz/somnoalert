      ...
      child: Column(
        ...
        children: [
          ...
          _EventList(
            ...
            subtitleBuilder: (event) => 'Duración: ${event.duration.toStringAsFixed(1)} s',
          ),
          const SizedBox(height: 12),
          _EventList(
            title: 'Cabeceos',
        ...
        children: [
          if (events.isEmpty)
            ...
            ListView.separated(
              ...
              separatorBuilder: (_, __) => const Divider(color: Colors.white12, height: 8, indent: 60),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(backgroundColor: Colors.blueAccent, child: const Icon(Icons.pan_tool, color: Colors.white)),
              const SizedBox(width: 12),
              Text(
                'Frote de ojos',
                style: Theme.of(context).textTheme.titleMedium?.copyWith(color: Colors.white),
